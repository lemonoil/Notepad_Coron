...
#include <memory>
#include "../../CPP_NotePad_project/findwindow.h"
...
QT_MOC_LITERAL(3, 21, 10), // "findButton"
QT_MOC_LITERAL(4, 32, 15) // "findButtonClick"

    },
    "Findwindow\0findnext\0\0findButton\0"
    "findButtonClick"
};
...
void Findwindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->findnext((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2])),(*reinterpret_cast< bool(*)>(_a[3]))); break;
        case 1: _t->findButton(); break;
        case 2: _t->findButtonClick(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Findwindow::*)(QString , bool , bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Findwindow::findnext)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Findwindow::findnext(QString _t1, bool _t2, bool _t3)
{
